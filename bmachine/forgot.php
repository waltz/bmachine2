...
if (isset($_POST["email"])) {
	...
	if ($found) {
		...
		$hash = urlencode(base64_encode( $username . "|" . 
...
if (isset($_POST["username"])) {
	...
	$store->updateUser($_POST["username"],$hash,$_POST["email"],isset($_POST["admin"]),false, false);
...
?>
	...
	<p>Your account information has been sent to <?php echo $_POST["email"]; ?>.</p>
...
?>
	...
	<p>BM can't send mail because of a problem with the mail configuration.  Please contact your server administrator.</p>
...
?>
		...
		<p>We were unable to find an account with the email address "<?php echo $_POST["email"]; ?>".  Please <a href="newuser.php">create a new account</a> or enter a different email address below.
