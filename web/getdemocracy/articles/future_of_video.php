...
<p>That's not to say that video RSS isn't doing well. It is. We've seen the number of channels in our Channel Guide increase 6 fold in the past year and channels are getting created faster and faster.  But there's big and then there's BIG.  YouTube is gigantic in a way that video RSS doesn't approach right now.</p>

<p>YouTube doesn't need defending, but I want to to be clear about exactly where more concerns are focused.  As a service and a universe, YouTube is amazing.  It has become a visual search engine of human experience.  So far, YouTube has done more to democratize video online than my organization or any of the other companies and advocates that are working for open-access and open-standards.  </p>

<p>But --and this is crucial-- YouTube is spending money like crazy.  They'll need to make it all back sometime and I'm nervous about how they will do it.  Do YouTube executives have any option other than to hold viewers and creators hostage to ads on videos?  Maybe not. </p>

<p>Furthermore, I worry that the near-monopoly strength of YouTube's network effect is dragging along people who don't actually want to use the service-- "If my video isn't on YouTube, will anyone find it??"  MySpace is the best example of this un-resistable social force in action-- how many web 2.0 gurus cringe everyday when they try to update their MySpace page? MySpace, by the way, is trying to be the next YouTube (that's the real dystopic scenario here).</p>
