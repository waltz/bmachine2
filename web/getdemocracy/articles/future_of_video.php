<?php include "../include/start.php"; ?>
		...
		<div id="content-2col">
			...
			<div id="sub-main-2col">
				&nbsp;
				<h2 style="font-size: 17px; margin: 0px 0 0 0; padding: 15px 0 0 0 ; line-height: 17px; color: #333;">THE FUTURE OF ONLINE VIDEO</h2><h2 style="margin: -33px 0 2px 0; padding: 0; line-height: 35px; font-size: 30px;"><Br />Openness Matters. RSS Can Help.</h2>
