...
<div id="footer">
		<ul>
			...
			<li>
				<a href="http://getdemocracy.com/make">Make TV</a>
					<ul>
			...
			<li>
				<a href="http://getdemocracy.com/code">Code</a>
					<ul>
			...
			<li>
				<a href="http://getdemocracy.com/help/">Help and Forums</a>
					<ul>
			...
			<li>
				<a href="http://getdemocracy.com/about">About the Platform</a>
					<ul>
