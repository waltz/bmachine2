...
print<<<END
		...
		<div id="sub-main">
			...
			<img src="/images/img_broadcastmain.jpg" style="margin:15px 0" />
		</div>
		<div id="content">
			...
			<p>Check out the <a href="http://www.getdemocracy.com/broadcast/help/">Broadcast Machine Help</a> page for info on: publishing files, creating channels, Broadcast Machine settings, user permissions, iTunes compatibility, BitTorrent troubleshooting, upgrade instructions, and more.</p>

			</div>
			<div id="content-right-broad">
				<h4>iTunes Compatible</h4>
				<img src="/images/img_itunesscreen.png" />
				...
				<img src="/images/img_torrentscreen.png" />
				...
				<h4>Easy to Use</h4>
				<img src="/images/img_easyscreen.png" />
				...
				<h4>Sites Using Broadcast Machine</h4>
					...
					<p>For additional news <a href="/news/feed" class="feed">subscribe to our blog feed</a>.</p>

					<h4>Broadcast Machine Support</h4>
						<ul>
							<li><a href="http://www.getdemocracy.com/broadcast/help/">Help and FAQ</a></li>
				  		</ul>
