...
print<<<END
		...
		<div id="main">
			<div id="callout">
				...
				<div id="callout-left">
					<p id="quote">"As easy as turning on a TV"<br />
						<span class="quote-byline">Cory Doctorow, boingboing.net</span>
					</p>
					<p id="description">Download and watch all the best internet TV shows and videos in <span class="hl">one powerful application</span>. New channels arrive <span class="hl">daily</span> in the
					built-in Channel Guide. Stop squinting at tedious web videos: sit back and watch big, <span class="hl">high resolution</span> videos.</p>
					<div id="downloadarea">
						<div id="download-aux"><a href="/watch">Learn More</a> - <a href="/walkthrough">Screenshots</a></div>
END;
...
print<<<END
				...
				<img src="images/img_screen.jpg" border="0" width="421" height="348" />
			</div>
		</div>
		<div id="subcallout">
			<div id="subcontent">
				...
				you can subscribe with a single-click. Submit your channel-- the Guide is open to everyone. A few examples:</p>
				<ul>
		...
		<div id="otherplat">
			...
			<div id="otherplat-left">
				<a href="#"><img src="images/img_broadcastmachine.gif" border="0" /></a>
				<a href="#" class="plathead">Broadcast Machine</a><br />Free software for your website to publish videos into a channel and create a browsable web gallery. RSS, BitTorrent, and an easy to use interface. <br /> <a href="#">Learn More >></a>
			</div>
			<div id="otherplat-right">
				<a href="#"><img src="images/img_videobomb.gif" border="0" /></a>
				<a href="#" class="plathead">Video Bomb</a><br /> The best videos from everywhere on the web. *Bomb* your favorites to push them to the front page. You can now bomb via Democracy Player.<br /> <a href="#">Go to Video Bomb >></a>
			</div>
			<div class="clearer"></div>
		</div>
		<div id="content">
