...
?>
		...
		<div id="subcallout">
			<div id="subcontent">
				...
				<p id="subdesc">When you launch Democracy Player, you'll see the built-in Channel Guide. New channels arrive every day, and you can subscribe to any with a single-click.  The Guide is open to everyone: <a href="https://channelguide.participatoryculture.org/?q=submitchannel">Submit a Video RSS Feed</a></p>
				<ul>
			...
			<div id="subnews">
				...
				<ul>
					...
					<li><a href="<?= $base ?>/news/2006/09/try-out-democracy-player-09-rc0/">Help test Democracy Player 0.9 RC0</a></li>
					<li><a href="<?= $base ?>/articles/video_podcast_shootout.php">Video Podcast Shootout: iTunes vs. Democracy Player</a></li>
					<li><a href="https://launchpad.net/products/democracy/trunk/+pots/democracyplayer">Translate Democracy Player</a></li>
				</ul>
