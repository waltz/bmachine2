...
<p>We made these decisions for DTV because it allows us to present rich metadata to users along with the associated video file.  This also reflects our belief that internet TV should not be a subset of blogging-- video is the medium that we're working with and each item in a video channel should be first and foremost a video file.</p>


<p>Eventually we may define some DTV-specific channel subscription settings.</p>
