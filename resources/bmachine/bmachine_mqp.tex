...
A quick and dirty way to create a new theme is to use a theme that is already in existance and simply create a new style sheet that changes the layout and look. 
...
Drupal is module based. 
It allows developers to create modules that inferface with the base code and modify or enhance the functionality of the software. 
