...
A Drupal module is nothing more than plain text file which contains PHP code. 
Module code is executed in during the normal runtime of the site, not beforehand or afterwards. 
