...
ing engines include: XTemplate, PHPTemplate, and Smarty. 
...
You would need to first determine which parts of the code are exclusively presentation elements and which were logical elements. 
...
Below we will discuss the pros and cons of these pieces of software and explain more why it is necessary for us to design a new architecture for Broadcast Machine. 
