...
Drupal has a very flexible templating system. By default, PHPTemplate is the templating engine, however it also supports a number of other common templating engines. As of version 5.0, Drupal interfaces with Smarty, XTemplate, and PHPTemplate. It also allows for the use of individual cascading style  sheets (CSS) files for each theme.
...
Drupal also provides module programmers with the ability to theme the software they create. 
