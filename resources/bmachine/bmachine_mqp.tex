...
Smarty integrates with CSS, XHTML, and PHP to create a framework for abstracting logic from the view layer. 
It's a flexible tag based templating system which 
