...
Unlike Drupal and the current version of Broadcast Machine, Wordpress does not have an output variable that is updated throughout the template 

Each file is included at some point during the run of the engine. 
All pages are generated on the fly, there's no server-side caching. 
...
Next the Wordpress engine checks  goes through a number of theme directory 
