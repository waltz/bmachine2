...
the various controllers, the database model and the views. 
...
\section{Summary}
In this chapter we showed how the software system operates in a real-life situation. We showed the steps a user would take to install and 
...
function.
Quality Assurance for Broadcast Machine was an ongoing process that began very 
early on in our development cycles, in order to provide 
